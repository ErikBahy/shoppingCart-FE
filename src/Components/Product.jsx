...
function Product(props) {
  const DetailContext = useContext(ProductContext);
    ...
    <ProductWrapper className="col-9 mx-auto col-md-6 col-lg-3 my-3">
      <div className="card">
        <div
          ...
          onClick={() => DetailContext.handleDetail(_id)}
        >
          <Link to="/details">
          ...
          <button
            ...
            onClick={() => {
              DetailContext.addToCart(props.product);
              DetailContext.openModal(props.product);
            }}
          >
            {inCart ? (
